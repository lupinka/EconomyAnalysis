...
## Merge worldIndicators and goldPrices
```{r merge}
...
## Corelation Matrix
```{r fig.height=105, fig.width=105}
names <- rownames(mostImoortantIndicators_Gold)
names <- gsub("`", "", all_of(names))
res <- cor(worldIndicatorsComplementedDf[names])
corrplot(res, method = 'square', order = 'AOE', type = 'lower', diag = FALSE,  tl.cex=5, cl.cex=4)
```
