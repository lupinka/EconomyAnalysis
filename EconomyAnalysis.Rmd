...
goldPricesAndWorldIndicators_mis <- missForest(goldPricesAndWorldIndicators[4:219])
goldPricesAndWorldIndicators_mis_ximp <- goldPricesAndWorldIndicators_mis$ximp
goldPricesAndWorldIndicators <- goldPricesAndWorldIndicators$ximp
control <- trainControl(method="repeatedcv", number=10, repeats=3)
model <- train(gold_usd~., data=goldPricesAndWorldIndicators, method="rf", preProcess="scale", trControl=control)
